...
_HELP_ROWS: list[tuple[str | None, str, str]] = [
    ...
    ("/last [N]", "", "Show the last N turns again (default 5) — a clean view after undos, regens, etc."),
    (None, "", "Stories:"),
    ("/stories", "Ctrl+T", "Browse stories, resume an old one"),
    ("/fork [TITLE]", "", "Continue in a copy of this story; the original stays"),
    ("/system <text | FILE>", "", "Set the system prompt (for this story); an existing file's path reads it from the file"),
