"""How printed text moves the cursor.
...
`terminal_width` is the width the simulation wraps and measures at.
Everything here is pure — asking the real terminal where its cursor is
lives in `terminal.query`.
